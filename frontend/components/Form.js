...
function Form(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await dispatch(createQuiz(quizPayload)); // Use dispatch here
...
export default connect(null)(Form); // No need to pass action creator now


// import React, { useState } from 'react';
// import { connect } from 'react-redux'; // Make sure you have the right version of 'react-redux'
// import { createQuiz } from '../state/action-creators';
